...
export const keywordContents = [
  {
    id: 1,
    title: '비타민',
    src: '/images/best_vitamin.png',
  },
  {
    id: 2,
    title: '프로폴리스',
    src: '/images/best_propolis.png',
  },
  {
    id: 3,
    title: '엽산',
    src: '/images/best_folic.png',
  },
  {
    id: 4,
    title: '유산균',
    src: '/images/best_lactos.png',
  },
  {
    id: 5,
    title: '루테인',
    src: '/images/best_lutein.png',
  },
];
...
export const kickContents = [
  {
    ...
    desc: '추천 키워드 & 카테고리별 검색 제안과\n제품명, 원재료명, 건강 관련 키워드 등 자유로운 검색으로\n다양한 제품들을 찾아볼 수 있습니다',
    src: '',
  },
  {
    id: 2,
    title: '사용자를 고려한 식품 정보',
    desc: '식약처가 인증한 건강기능식품에 대한 기본 정보 뿐 아니라\n함께 섭취하면 좋은, 나쁜 성분 정보도 담았습니다\n관심 가는 식품은 마이페이지에서 한 눈에 볼 수 있습니다',
    src: '',
  },
  {
    id: 3,
    title: '식품별 리뷰 모아보기 ',
    desc: '건강기능식품에 대한 정보와 더불어 유저들의 리뷰, 좋아요 기능,\n유저들의 식품 섭취기간에 따른 필터링 기능을 제공합니다\n마이페이지에서 내가 쓴 리뷰를 모아볼 수 있습니다',
    src: '',
  },
];
